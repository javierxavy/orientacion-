...
@section('content')
    <div class="container">
      ...
      <br>
      <br>
       <div class="alert alert-warning" role="alert"><p id="PP">Deportes</p></div>
    <!-- Example row of columns -->
    <div class="row">
      <div class="col-md-6">
        <h2></h2>
        <img src="C:\xampp\htdocs\orientacion\public\img\Tigre Personaje\Personajes pag principal Artes, Deportes y Academico\Tigre Deportivo.png" class=" img-responsive" alt="">
